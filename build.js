...
console.log('🚀 Starting project build for Vercel deployment...');
...
try {
  ...
  // 2. Clean and move build output to root /dist folder
  console.log('🚚 Routing static files to root "/dist"...');
  fs.rmSync('dist', { recursive: true, force: true });
  fs.cpSync('smarthire-react/dist', 'dist', { recursive: true });
  fs.rmSync('smarthire-react/dist', { recursive: true, force: true });
