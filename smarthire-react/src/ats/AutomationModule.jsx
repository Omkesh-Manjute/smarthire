...
function AutomationModule({ apiOnline }) {
  ...
  const integrations = [
    ...
    { icon: '🎥', name: 'PeekHire Video Screening', description: 'Async video & voice screening', status: 'Active', statusClass: 'pill-ok', detail: 'PeekHire media sessions active. Automated Groq Whisper transcription & candidate evaluation.' },
  ]
