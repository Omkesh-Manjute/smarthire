      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FFF" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>
          </div>
          <div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 13 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              <span style={{display: 'inline-flex', alignItems: 'center' }}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg></span>
              <span>US Clocks</span>
        ...
        <div style={{ maxWidth: 960, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 2 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{display: 'inline-flex', alignItems: 'center' }}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></span>
              <input
                type="text"
                value={searchQuery}
          ...
          <div style={{
            ...
            {filteredJobs.map((job) => {
              ...
              const summaryText = (() => {
                ...
                const clean = fullDesc.replace(/=+/g, '').replace(/POSITION.*?\n/gi, '').replace(/•.*?\n/g, '').trim()
                ...
                >
                  <div className="sh-card-body">
                    ...
                    <div className="sh-metadata-container">
                      <span className="sh-metadata-item">
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginRight: 4 }}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>{locationText}
                      </span>
                  ...
                  <div className="sh-card-footer">
                    <span style={{ fontSize: 12, color: theme.textSecondary, display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginRight: 5 }}><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg><strong style={{color: theme.textPrimary, fontWeight: 600 }}}>{job.employment_type || job.type || 'Contract'}</strong>
                    </span>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      {appliedJobs[job.id] ? (
                        ...
                        >
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg> <span>Chat</span>
                        </button>
                      ) : expired ? (
