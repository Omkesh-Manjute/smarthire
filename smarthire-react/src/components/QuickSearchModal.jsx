...
const SEARCH_ITEMS = [
  ...
  { id: 'ats-screen', title: 'Video & Audio Screening (SmartHire)', category: 'ATS Suite', icon: '', path: '/ats?tab=screening', keywords: 'screening video voice audio smarthire interview async responses' },
