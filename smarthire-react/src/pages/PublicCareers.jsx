...
export default function PublicCareers() {
  ...
  return (
    <div style={{
      ...
      {/* ─── FLOATING 1-CLICK QUICK LAYOUT SWITCHER PILL (BOTTOM-LEFT) ──────── */}
      <div style={{
        position: 'fixed',
        bottom: 24,
        left: 24,
        ...
        alignItems: 'center',
        gap: 6,
        boxShadow: isLight ? '0 10px 25px rgba(0, 0, 0, 0.12), 0 2px 6px rgba(0,0,0,0.06)' : '0 10px 30px rgba(0, 0, 0, 0.5)',
        ...
        <button
          ...
          title="Switch to Classic Executive ATS design"
          style={{
            backgroundColor: layoutView === 'classic' ? '#2563EB' : 'transparent',
            color: layoutView === 'classic' ? '#FFFFFF' : (isLight ? '#334155' : '#CBD5E1'),
            border: 'none',
            borderRadius: 20,
            padding: '5px 12px',
            fontSize: 12,
            ...
            boxShadow: layoutView === 'classic' ? '0 2px 8px rgba(37, 99, 235, 0.4)' : 'none'
          }}
        >
          <span>🏛️</span>
        ...
        <button
          ...
          title="Switch to Modern Zone Career design"
          style={{
            backgroundColor: layoutView === 'zone' ? '#FA541C' : 'transparent',
            color: layoutView === 'zone' ? '#FFFFFF' : (isLight ? '#334155' : '#CBD5E1'),
            border: 'none',
            borderRadius: 20,
            padding: '5px 12px',
            fontSize: 12,
            ...
            gap: 5,
            transition: 'all 0.15s ease',
            boxShadow: layoutView === 'zone' ? '0 2px 8px rgba(250, 84, 28, 0.4)' : 'none'
          }}
        >
          <span>✨</span>
